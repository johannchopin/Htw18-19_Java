...
public class FuncTools
{
    ...
    /**
     * Stellt die Tabelle von Tripel (@see zahlentripelRechner) dar
     * 
     * @param tab Tabelle von Tripel
     */
    ...
    /**
     * Methode, die die Tabelle rechnet (@see zahlentripelRechner) und stellt
     * die Tabelle dar.
     * 
     ...
     * 
     * @param bound Grenze zu berechnen
     * @param x f(x)
     */
    public static double mathematischeFolge(long bound, double x){
        check_arguments(bound > 0, MSG_BOUND);      
        double x1 = x-1;
        double x2 = x;
        double acc = x1/x2;
        double old_x1, old_x2;
    ...
    public static void main(String[] args){
       printTripelArray(zahlentripelRechner(101));
    }
}
